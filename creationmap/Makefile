...
SOURCES = \
	__init__.py \
	CreationMap.py CreationMap_dialog.py

PLUGINNAME = CreationMap

PY_FILES = \
	__init__.py \
	CreationMap.py CreationMap_dialog.py

UI_FILES = CreationMap_dialog_base.ui
...
QGISDIR=C:\Users\af00o\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
